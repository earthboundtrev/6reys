      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-800 p-8 rounded-lg">
            ...
            <h3 className="text-xl font-bold mb-2">Weekly Fighting Game Tournament</h3>
            <p className="text-gray-400 mb-4">Every Friday @ 7PM</p>
          ...
          <div className="bg-gray-800 p-8 rounded-lg">
            ...
            <p className="text-gray-400 mb-4">Last Saturday of Every Month</p>
            <ul className="text-gray-400 space-y-2">
              <li>• DoDonPachi</li>
